(function(){
  ...
  app.component('prmTopbarAfter', {
    ...
    template: 
      '<div class="header-alert"><div class="alert-text"><p>This is the <strong>legacy version</strong> of the <a href="https://search.lib.latrobe.edu.au/nde/home?vid=61LATROBE_INST:LIBRARY">Library Collection Search</a>. It is only available until <strong>11 October 2026</strong>. Any <strong>saved searches</strong> or <strong>permalinks</strong> from this version will <strong>no longer be accessible</strong> after this date. <a href="https://www.latrobe.edu.au/news/announcements/2026/library-collections-search-will-soon-have-a-new-look" target="_blank">Find out more.</a></p></div></div>'+
